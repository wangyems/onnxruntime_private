...
inline cublasStatus_t cublasGemmStridedBatchedHelper(
    ...
    long long int strideA, const onnxruntime::BFloat16* B, int ldb,
    long long int strideB, const onnxruntime::BFloat16* beta, onnxruntime::BFloat16* C, int ldc,
...
inline cublasStatus_t cublasGemmStridedBatchedHelper(
    ...
    int, const onnxruntime::BFloat16*, const onnxruntime::BFloat16*, int, long long int,
    const onnxruntime::BFloat16*, int, long long int, const onnxruntime::BFloat16*, onnxruntime::BFloat16*,
